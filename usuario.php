...
<div class="divtabla">
<br><br>
<a href="cambiarconf.php"> <button  id="aceptar" type="button" name="button">Cambiar configuración</button></a>
<br><br>
<a href="pendiente.php"><button  id="aceptar" type="button" name="button">Ver pedidos pendientes</button></a>
<br><br>
<a href="pedidosrealizados.php"><button  id="aceptar" type="button" name="button">Ver pedidos realizados</button></a>
<br><br>
